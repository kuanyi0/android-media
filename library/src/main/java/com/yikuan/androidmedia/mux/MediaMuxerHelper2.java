 ...
 * @date 2020/10/21
 */
public class MediaMuxerHelper2 extends Worker1<MediaMuxerHelper2.Param> {
    private static final String TAG = "MediaMuxerHelper2";
    ...
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN_MR1)
    public long getPts() {
        return isRunning() ? (SystemClock.elapsedRealtimeNanos() - mStartTime) / 1000 : 0;
    }
